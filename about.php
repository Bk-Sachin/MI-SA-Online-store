...
?>
	...
	<!-- Title page -->
	<section class="bg-img1 txt-center p-lr-15 p-tb-92" style="background-image: url('images/knifeandfork.jpg');">
		...
		<div class="container">
			<div class="row p-b-148">
				...
				<div class="col-11 col-md-5 col-lg-4 m-lr-auto">
					<div class="how-bor1 ">
						<div class="hov-img0">
							<img src="images/sachin.jpg" alt="IMG">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="order-md-2 col-md-7 col-lg-8 p-b-30">
					<div class="p-t-7 p-l-85 p-l-15-lg p-l-0-md">
						...
						<p class="stext-113 cl6 p-b-26">
							Our mission is simple. Provide you with the finest tools and prople. That way, you will never go back to any other service.
						</p>

						<div class="bor16 p-l-29 p-b-9 m-t-22">
							<p class="stext-114 cl6 p-r-40 p-b-11">
								After this, we will be able to control all the househould product industry like windows
								 control the IT industry.
							</p>
